...
local function _debugCompletedTooltip(lines)
    ...
    utils.d("[Nvk3UT][Completed][TooltipData]", payload)
end
...
local function _updateCompletedTooltip(ach)
    ...
    for idx = 1, #orderedChildren do
        ...
        if data then
            ...
            if key then
                local pts = _completedPointsForKey(key)
