local strings = {
    ...
    SI_NVK3UT_LAM_OPTION_TRACKER_HOST_ALIGNMENT = "Tracker alignment",
    SI_NVK3UT_LAM_OPTION_TRACKER_HOST_ALIGNMENT_DESC = "Align tracker headers to the left or right. Changing this rebuilds the tracker UI.",
    SI_NVK3UT_LAM_OPTION_TRACKER_HOST_ALIGNMENT_LEFT = "Left-aligned",
    SI_NVK3UT_LAM_OPTION_TRACKER_HOST_ALIGNMENT_RIGHT = "Right-aligned",
