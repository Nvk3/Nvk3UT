...
- The agent may reference them conceptually, but must reimplement all functions from scratch using original logic and syntax.
...
- When replicating behavior from another addon (e.g., *Kaleido*, *BSC*), do so **conceptually**, not by copying.
