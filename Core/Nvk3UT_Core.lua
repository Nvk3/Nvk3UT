...
function Addon:SetDebugEnabled(enabled)
    ...
    if Nvk3UT_Diagnostics and Nvk3UT_Diagnostics.SetDebugEnabled then
        Nvk3UT_Diagnostics.SetDebugEnabled(value)
    elseif type(Nvk3UT) == "table" then
        Nvk3UT.debugEnabled = value
    end
end
